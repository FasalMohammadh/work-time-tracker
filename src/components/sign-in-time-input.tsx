...
function SignInTimeInput(props: SignInTimeInputProps) {
  ...
  return (
    <input
      type="time"
      required
      className="bg-slate-950/60 border w-full border-slate-800/50 rounded-lg p-3 text-white outline-none transition-all focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 cursor-pointer scheme-dark"
      value={$signInTime}
